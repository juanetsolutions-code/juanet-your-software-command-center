        ...
        <div className="relative overflow-hidden rounded-3xl glass-strong p-10 md:p-16 text-center">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Request a project, license a platform, or book a strategy call. We respond within one business day.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link to="/shop" className="inline-flex items-center gap-2 h-12 px-6 rounded-lg glass hover:bg-white/[0.08]">
                Browse marketplace
              </Link>
              <Link to="/contact" className="inline-flex items-center gap-2 h-12 px-6 rounded-lg hover:bg-white/5">
                Book a consultation
              </Link>
            </div>
          </div>
