...
export function StatCard({
  ...
  return (
    <div className="glass rounded-2xl p-5 relative overflow-hidden">
      <div
        className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-gradient-to-br opacity-20 blur-2xl"
      ...
      <div className="relative flex items-start justify-between">
        <div>
          ...
          <div
            className={cn(
              "mt-2 text-2xl font-semibold bg-gradient-to-r bg-clip-text text-transparent",
              accent,
            )}
          >
            {value}
