...
export const mockConversations: Conversation[] = [
  {
    id: "c-01",
    name: "Marcus Otieno",
    role: "Tech Lead — Atlas",
    preview: "Pushed the new auth flow to staging — could you take a look?",
    timeLabel: "12m",
    unread: 2,
    online: true,
  },
  {
    ...
    name: "Aisha Kamau",
    role: "PM — MediTrack",
    preview: "QA round 2 looks clean. Targeting Friday release.",
    timeLabel: "1h",
    unread: 0,
    online: true,
  },
  {
    ...
    name: "Joy Wanjiru",
    role: "Designer",
    preview: "Updated the dashboard tokens in Figma.",
    timeLabel: "3h",
    unread: 1,
    online: false,
  },
  {
    id: "c-04",
    name: "Brian Mwangi",
    role: "Backend — Harvest",
    preview: "Schema draft attached. Ready for review.",
    timeLabel: "Yesterday",
    unread: 0,
    online: false,
  },
  {
    ...
    name: "Kelvin Njoroge",
    role: "DevOps",
    preview: "CI pipeline migrated to the new runner.",
    timeLabel: "2d",
    unread: 0,
    online: true,
  },
  ...
  "c-01": [
    {
      ...
      conversationId: "c-01",
      author: "them",
      text: "Morning! Pushed the new auth flow to staging.",
      timeLabel: "09:12",
    },
    {
      id: "m-2",
      conversationId: "c-01",
      author: "them",
      text: "Includes magic-link + Google OAuth.",
      timeLabel: "09:12",
    },
    {
      id: "m-3",
      conversationId: "c-01",
      author: "me",
      text: "Awesome — testing now. Did you wire the audit log?",
      timeLabel: "09:24",
    },
    {
      id: "m-4",
      conversationId: "c-01",
      author: "them",
      text: "Yes, every sign-in event lands in `auth_events`.",
      timeLabel: "09:26",
    },
    {
      id: "m-5",
      conversationId: "c-01",
      author: "me",
      text: "Perfect. Let's demo this on Thursday's call.",
      timeLabel: "09:31",
    },
    {
      id: "m-6",
      conversationId: "c-01",
      author: "them",
      text: "Sounds good. I'll prep a short walkthrough deck.",
      timeLabel: "09:33",
    },
  ],
};
...
export const mockInvoices: Invoice[] = [
  {
    id: "INV-1048",
    projectName: "Atlas Banking Core — Sprint 6",
    amount: 8400,
    currency: "USD",
    status: "due",
    issuedLabel: "May 02, 2026",
    dueLabel: "May 22, 2026",
  },
  {
    id: "INV-1047",
    projectName: "MediTrack HMS — QA Retainer",
    amount: 3200,
    currency: "USD",
    status: "paid",
    issuedLabel: "Apr 28, 2026",
    dueLabel: "May 10, 2026",
  },
  {
    id: "INV-1046",
    projectName: "Harvest ERP — Discovery",
    amount: 1800,
    currency: "USD",
    status: "paid",
    issuedLabel: "Apr 18, 2026",
    dueLabel: "Apr 28, 2026",
  },
  {
    id: "INV-1045",
    projectName: "Skyline LMS v2 — Final",
    amount: 12500,
    currency: "USD",
    status: "paid",
    issuedLabel: "Apr 02, 2026",
    dueLabel: "Apr 16, 2026",
  },
  {
    id: "INV-1044",
    projectName: "RetailOps CRM — Sprint 3",
    amount: 540000,
    currency: "KES",
    status: "overdue",
    issuedLabel: "Mar 22, 2026",
    dueLabel: "Apr 05, 2026",
  },
  {
    id: "INV-1043",
    projectName: "Logix Fleet — Kickoff",
    amount: 2200,
    currency: "USD",
    status: "draft",
    issuedLabel: "—",
